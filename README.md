...
```powershell
$env:COUNT_LINE_ORIENTATION="vertical"; $env:COUNT_LINE_X_RATIO="0.5"; $env:SPEED_METERS_PER_PIXEL="0.05"; $env:MAX_FRAMES="300"; python src/main.py
```
...
- If your counting line isn't working for a specific sample video, it might be due to low visual quality! For example, YOLO can notoriously misclassify blurry rectangular cars as cell phones (class 67). Adjust the `vehicle_cls` in `src/traffic_analyzer.py` if this occurs!
